...
function createNFTcard (number,description,img,name,price,seller,time,e) {
    ...
    newdiv.innerHTML = `
    <img class="nft-img" src='${img}' /> <!-https://images.unsplash.com/photo-1597600159211-d6c104f408d1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=739&q=80->
...
function generateNFTs(){
  ...
  nftsarray.forEach(function(e){
    ...
    setTimeout(function(){
      ...
      document.querySelectorAll(".nft-img").forEach((img) => {
